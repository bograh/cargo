...
func TestValidateCreate(t *testing.T) {
	cases := []struct {
		...
		{"good mysql", CreateInput{Name: "orders", Engine: "mysql", Version: "8.4"}, true},
		{"good mongodb", CreateInput{Name: "docs", Engine: "mongodb", Version: "7"}, true},
		{"mysql with mode", CreateInput{Name: "orders", Engine: "mysql", Version: "8.4", RedisMode: "acl"}, false},
		...
		{"bad engine", CreateInput{Name: "orders", Engine: "cassandra", Version: "16"}, false},

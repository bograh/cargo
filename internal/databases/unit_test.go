...
func TestValidateCreate(t *testing.T) {
	cases := []struct {
		...
		{"short name", CreateInput{Name: "abc", Engine: "postgres", Version: "16"}, true},
		{"too short name", CreateInput{Name: "ab", Engine: "postgres", Version: "16"}, false},
		{"upper name", CreateInput{Name: "OrdersDB", Engine: "postgres", Version: "16"}, false},
		{"leading dash", CreateInput{Name: "-orders", Engine: "postgres", Version: "16"}, false},
